  ...
  return (
      <>
          <section className={'border-b-white flex-1 min-w-full overflow-y-hidden text-center content-center'}
              ...
              <i className={'mx-auto font-serif text-3xl'}>Poemas al alimon</i>
          ...
          <div className={'flex w-full'}>
              <section className={'flex flex-1 justify-center align-items-center'}><h2>Poemas y otras palabras</h2>
              </section>
